function [logicalVerticesInBlocks] = coeffFun_randomBlocks(x,y,N,n,n_blocks)
...
logicalVerticesInBlocks = false(size(x)); %initialisiere mit logical false fuer Punkt
width = 1:5;
height = 1:5;
